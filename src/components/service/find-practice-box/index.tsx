...
export default function FindPracticeBox() {
    return (
        <div className="relative flex flex-col items-center justify-center h-[325px] bg-white p-[20px] max-w-[720px] mx-auto rounded-[20px] text-[#002554] text-center z-0">
            <Image
            ...
            <p className="text-[18px] lg:text-[20px] mb-[24px]">Kontaktieren Sie uns bei technischen Fragen.</p>
