            ...
            <div className="container flex flex-col md:flex-row">
                <div className="md:my-[95px] mr-auto text-[#002554] mb-[12px]">
                    <h1 className="text-[83px] xl:text-[198px] lg:text-[110px] font-kanedaGothic font-bold md:font-normal leading-none mb-[24px] lg:md-[50px]">CoolSculpting<sup
                        className="font-avenirNext text-[50%] align-middle">®</sup></h1>
                    <p className="text-[18px] lg:text-[26px] max-w-[577px]">Die weltweit führende Kälte-Behandlung von hartnäckigen Fettpolstern.<sup>1-2</sup></p>
                </div>
                <Image src={"/images/homepage/banner.webp"} width={441} height={706} alt="CoolSculpting" />
                <Image
