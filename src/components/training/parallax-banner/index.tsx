        ...
        <section className="bg-[#005EB8] pt-[37px] md:pt-[95px] z-0 relative overflow-hidden">
            ...
            <div className="container flex flex-col md:flex-row">
                <div className="md:my-[95px] mr-auto text-white mb-[12px]">
                    <h1 className="text-[83px] xl:text-[198px] lg:text-[110px] font-kanedaGothic font-bold md:font-normal leading-none mb-[24px] lg:md-[50px]">Training</h1>
                    <p className="text-[18px] lg:text-[20px] max-w-[600px]">Ergänzend zu den Live-Trainings mit den CoolSculpting<sup>®</sup> Systemen bieten wir Ihnen hier zum Vertiefen oder Wiederholen Trainingsvideos zum Einsatz von CoolSculpting<sup>®</sup> an. So können Sie jederzeit und ganz gezielt Ihr Wissen auffrischen.</p>
                </div>
                <Image src={"/images/training/banner.webp"} width={471} height={715} alt="CoolSculpting" />
                <Image
